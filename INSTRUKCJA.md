...
| Kategoria | Przykłady |
|---|---|
| **Paliwo** | Tankowanie, AdBlue |
| **Części** | Klocki, żarówki, filtry, opony |
| **Obsługa** | Wymiana oleju, kontrola ciśnienia, mycie |
| **Usterka** | Awaria, naprawa nieplanowana |
| **Serwis** | Wizyta w warsztacie, przegląd |
...
| Ilość | Litry (paliwo) lub sztuki (części) |
| Kwota | Koszt w PLN |
...
| **Tankowanie do pełna** | Widoczne tylko dla kategorii Paliwo — zaznacz jeśli tankujesz do pełna (potrzebne do obliczania spalania) |
...
Nad tabelą wyświetlane są karty z łącznym kosztem i łączną ilością paliwa dla aktywnych filtrów.
...
| Per kategoria | Paliwo, Części, Obsługa itd. |

### Zużycie paliwa

Obliczane **tylko na podstawie tankowań do pełna** (wpisy Paliwo z zaznaczonym „Tankowanie do pełna").
...
- Tabela wszystkich tankowań do pełna z kolumną L/100km i trasą (km)

> **Wskazówka:** Im więcej tankowań do pełna, tym dokładniejsze statystyki. Pierwsze tankowanie po dodaniu pojazdu nie ma obliczonego spalania (brak punktu odniesienia).
